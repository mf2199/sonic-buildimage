...
class Psu(PsuBase):
    ...
    def get_powergood_status(self):
        ...
        Returns:
            A boolean, True if PSU has stablized its output voltages and passed
            all its internal self-tests, False if not.
        """
    ...
    def set_status_led(self, color):
        ...
        Args:
            color: A string representing the color with which to set the PSU
                   status LED. Note: Only support green and off
        Returns:
