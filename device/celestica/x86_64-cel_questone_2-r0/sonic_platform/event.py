...
class SfpEvent:
    ...
    def __initialize_interrupts(self):
        ...
        for index in range(self.num_sfp):
            ...
            elif port_num in range(
                self.QSFP_PORT_START, self.QSFP_PORT_END + 1
            ):
...
class VoltageEvent:
    ...
    VOLTAGE_CONFIG = {
        0: {"name": "XP3R3V_FD", "max": 3470, "min": 3140},
        1: {"name": "XP3R3V", "max": 3470, "min": 3140},
        2: {"name": "XP1R82V", "max": 1950, "min": 1470},
        3: {"name": "XP1R05V", "max": 1068, "min": 1032},
        4: {"name": "XP1R7V", "max": 1785, "min": 1615},
        5: {"name": "XP1R2V", "max": 1260, "min": 1140},
        6: {"name": "XP1R3V", "max": 1352, "min": 1248},
        7: {"name": "XP1R5V", "max": 1580, "min": 1430},
        8: {"name": "XP2R5V", "max": 2750, "min": 2375},
        9: {"name": "XP0R6V_VTT", "max": 632, "min": 568},
    }
