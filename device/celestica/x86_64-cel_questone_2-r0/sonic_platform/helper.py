...
class APIHelper:
    ...
    def ipmi_fru_id(self, id, key=None):
        ...
        try:
            cmd = (
                "ipmitool fru print {}".format(str(id))
                if not key
                else "ipmitool fru print {0} | grep '{1}' ".format(
                    str(id), str(key)
                )
            )
    ...
    def fru_decode_product_serial(self, data):
        if data and data[4] != 00:
            ...
            start_product_Manu_name_length = (
                ord(data[start_product_Manu_name]) & 0x0F
            )
            start_product_name = (
                start_product_Manu_name + start_product_Manu_name_length + 1
            )
            start_product_name_length = ord(data[start_product_name]) & 0x0F
            start_product_module_number = (
                start_product_name + start_product_name_length + 1
            )
            start_product_module_number_length = (
                ord(data[start_product_module_number]) & 0x0F
            )
            start_product_version = (
                start_product_module_number
                + start_product_module_number_length
                + 1
            )
            start_product_version_length = (
                ord(data[start_product_version]) & 0x0F
            )
            start_product_serial_number = (
                start_product_version + start_product_version_length + 1
            )
            start_product_serial_number_length = (
                ord(data[start_product_serial_number]) & 0x1F
            )
            return data[
                start_product_serial_number
                + 1 : start_product_serial_number
                + start_product_serial_number_length
                + 1
            ]
        return "N/A"
    ...
    def fru_decode_product_model(self, data):
        if data and data[4] != 00:
            ...
            start_product_manu_name = start_product_lang_code + 1
            start_product_manu_name_length = (
                ord(data[start_product_manu_name]) & 0x1F
            )
            start_product_name = (
                start_product_manu_name + start_product_manu_name_length + 1
            )
            ...
            start_product_module_number_length = (
                ord(data[start_product_module_number]) & 0x1F
            )
            return data[
                start_product_module_number
                + 1 : start_product_module_number
                + start_product_module_number_length
                + 1
            ]
        return "N/A"
    ...
    def fru_decode_product_name(self, data):
        if data and data[4] != 00:
            ...
            return data[
                start_product_name
                + 1 : start_product_name
                + start_product_name_length
                + 1
            ]
