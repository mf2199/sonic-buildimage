...
class Watchdog(WatchdogBase):
    ...
    def _settimeout(self, seconds):
        ...
        # set high bit
        self._api_helper.write_file(self.setreg_path, set_h_val)

        # set med bit
        self._api_helper.write_file(self.setreg_path, set_m_val)

        # set low bit
        self._api_helper.write_file(self.setreg_path, set_l_val)
