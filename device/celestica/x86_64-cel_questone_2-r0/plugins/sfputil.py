...
class SfpUtil(SfpUtilBase):
    ...
    def get_eeprom_dom_raw(self, port_num):
        if port_num in self.qsfp_ports:
            # QSFP DOM EEPROM is also at addr 0x50 and thus also stored in
            # eeprom_ifraw
            return None
        else:
    ...
    def __init__(self):
        ...
        for x in range(self.PORT_START, self.PORT_END + 1):
            # port_index = 0 , it's path = /sys/bus/i2c/devices/i2c-10/10-0050/eeprom  # noqa: E501
            # port_index = 55, it's path = /sys/bus/i2c/devices/i2c-65/65-0050/eeprom  # noqa: E501
    ...
    def get_presence(self, port_num):
        ...
        sysfs_filename = (
            "qsfp_modprs" if port_num in self.qsfp_ports else "sfp_modabs"
        )
    ...
    def tx_disable(self, port_num, disable):
        ...
        if (
            port_num not in range(self.port_start, self.port_end + 1)
            or type(disable) != bool
        ):
            return False
        ...
        # SFP, set tx_disable pin
            ...
            try:
                ...
                reg_file = open(
                    "/".join(
                        [self.PORT_INFO_PATH, port_name, "sfp_txdisable"]
                    ),
                    "w",
                )
    ...
    def reset_all(self):
        ...
        for port in range(self.port_start, self.port_end + 1):
            ...
            try:
                ...
                sysfs_path = "/".join(
                    [self.PORT_INFO_PATH, port_name, "qsfp_reset"]
                )
